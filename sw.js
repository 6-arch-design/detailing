const CACHE_NAME = "detailing-app-v46";
...
self.addEventListener("fetch", event => {
  ...
  if (url.pathname.endsWith(".html") || url.pathname.endsWith(".css") || url.pathname.endsWith(".js") || url.pathname.endsWith(".json") || url.pathname.endsWith(".svg")) {
